...
// A driver owns their own availability — everything else on their record (salary, licence
// data, employment status) stays under the employing transporter's control.
